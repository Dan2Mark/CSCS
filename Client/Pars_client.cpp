...
class Pars_client{
    ...
    bool check_cmd(int cnt) {
        ...
        else if (strcmp(words[0], "clear") == 0)
        {
            ...
            else {cout << "Неверный синтаксис команды: clear color\n" << endl;
            return false;
            }
        }
        //pixel x1 y1 color
        else if (strcmp(words[0], "pixel") == 0)
        {
            if (cnt == 4) {
                cmd[0] = 1;
                return (check_int(words[1]) && check_int(words[2]) && check_color(words[3]));
            }
            else {cout << "Неверный синтаксис команды: pixel x1 y1 color\n" << endl;
            return false;
            }
        }
        ...
        else if (strcmp(words[0], "line") == 0)
        {
            ...
            else {cout << "Неверный синтаксис команды: line x1 y1 x2 y2 color\n" << endl;
            return false;
            }
        }
        ...
        else if (strcmp(words[0], "rect") == 0)
        {
            ...
            else {cout << "Неверный синтаксис команды: rect x1 y1 w h color\n" << endl;
            return false;
            }
        }
        ...
        else if (strcmp(words[0], "fill_rect") == 0)
        {
            ...
            else {cout << "Неверный синтаксис команды: fill_rect x1 y1 w h color\n" << endl;
            return false;
            }
        }
        ...
        else if (strcmp(words[0], "ell") == 0)
        {
            ...
            else { cout << "Неверный синтаксис команды: ell x1 y1 w h color\n" << endl;
            return false;
            }
        }
        ...
        else if (strcmp(words[0], "fill_ell") == 0)
        {
            ...
            else { cout << "Неверный синтаксис команды: fill_ell x1 y1 w h color\n" << endl;
            return false;
            }
        }
        ...
        else if (strcmp(words[0], "circle") == 0)
        {
            ...
            else { cout << "Неверный синтаксис команды: circle x1 y1 rad color\n" << endl;
            return false;
            }
        }
        ...
        else if (strcmp(words[0], "text") == 0)
        {
            if (cnt >= 6) {
                ...
                for (int i = 4; i < cnt - 1; i++) out = out + words[i] + ' ';
            }
            else {
        ...
        int w = char_to_int(words[3]), h = char_to_int(words[4]);
            if (cnt == 5 + w * h) {
                ...
                for (int i = 5; i < w * h + 5; i++) check_color(words[i]);
                return out;
            }
            else {
                cout << "img x1 y1 w h data\n" << endl;
                return false;
            }
        }
        //get width/height
